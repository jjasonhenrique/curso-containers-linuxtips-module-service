...
| <a name="input_secrets"></a> [secrets](#input\_secrets) | Lista de secrets do parameter store ou secrets manager. | <pre>list(object({<br/>    name : string<br/>    valueFrom: string<br/>    <br/>  }))</pre> | `[]` | no |
